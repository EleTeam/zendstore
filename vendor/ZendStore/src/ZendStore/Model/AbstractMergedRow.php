 ...
 */
abstract class AbstractMergedRow
	implements MergedRowInterface, \ArrayAccess, \Countable
{
	/**
	 * @var string
	 */
	...
	/**
	 * @see MergedRowInterface::getJoinedRow()
	 */
	...
	/**
	 * @see MergedRowInterface::setJoinedRow()
	 */
	...
	/**
	 * @see MergedRowInterface::getJoinedRows()
	 */
